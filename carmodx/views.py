...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            <h6>🚨 BOOKING ACCESS ISSUE IDENTIFIED:</h6>
                            <p><strong>Only customers can book appointments!</strong></p>
                            <p>You're currently logged in as an employee. To test booking:</p>
                            <ol>
                                <li><a href="/accounts/logout/" class="btn btn-sm btn-warning">Logout</a></li>
                                <li><a href="/accounts/login/" class="btn btn-sm btn-primary">Login as Customer</a></li>
                                <li>Use username: <code>test</code> or <code>testcustomer</code></li>
                                <li><a href="/appointments/book/" class="btn btn-sm btn-success">Go to Booking</a></li>
                            </ol>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadTestSlots() {
            ...
            log('🔍 loadTestSlots() called for date: ' + selectedDate);
            ...
            setTimeout(() => {
                ...
                testSlots.forEach(slot => {
                    ...
                    log('➕ Added slot: ' + slot.time + ' - ' + slot.display);
                });
                
                timeSelect.value = '';
                log('✅ Dropdown populated with ' + testSlots.length + ' slots');
                log('Current dropdown options count: ' + timeSelect.options.length);
            }, 500);
        }
        
        log('🚀 Setting up test event listeners...');
        dateInput.addEventListener('change', function(event) {
            log('📅 Date changed to: ' + event.target.value);
            loadTestSlots();
        });
